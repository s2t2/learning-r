...
# RUN THIS:
#install.packages(c('maps', 'sf', 'rgeos', 'rnaturalearth', 'knitr', 'cowplot', 'viridis',  'tidyverse', 'here', 'janitor', 'devtools'))
#devtools::install_github("ropensci/rnaturalearthhires")
#devtools::install_github("ropensci/rnaturalearthdata")
...
```{r}
central_park <- st_read(here::here('data', 'central_park', 'CentralPark.shp'))
...
world$code <- world$iso_a3
#df_merge <- merge(internet_users_2015, world, by="code")
df_merge <- merge(world, internet_users_2015, by="code")
View(df_merge)
```
